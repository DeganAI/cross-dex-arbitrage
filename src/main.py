...
async def root():
    ...
    <head>
        ...
        <meta name="description" content="Discover cross-DEX arbitrage opportunities via x402 micropayments">
        <meta property="og:title" content="Cross DEX Arbitrage Alert">
        <meta property="og:description" content="Discover cross-DEX arbitrage opportunities via x402 micropayments">
        <meta property="og:image" content="https://cross-dex-arbitrage-production.up.railway.app/favicon.ico">
            ...
            "accepts": [{
                ...
                "outputSchema": {
                    "input": {
                        ...
                        "bodyType": "json",
                        "bodyFields": {
                            "token_in": {"type": "string", "required": True, "description": "Input token address or symbol"},
                            "token_out": {"type": "string", "required": True, "description": "Output token address or symbol"},
                            "amount_in": {"type": "string", "required": True, "description": "Amount to swap in token units"},
                            "chain_id": {"type": "number", "required": True, "description": "Chain ID to scan DEXes on"}
                        }
                    },
                    "output": {"type": "object", "description": "Cross-DEX arbitrage opportunities with profit calculations"}
                }
            }]
        }
    )
